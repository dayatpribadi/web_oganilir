(function ($) {
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    if ($("[data-bg-sz]").length > 0) {
        $("[data-bg-sz]").each(function () {
            var size = $(this).attr("data-bg-sz");
            $(this).css("background-size", size);
            $(this).removeAttr("data-bg-sz");
        });
    }
    ...
    $(".th-carousel").each(function () {
        ...
        if (d("arrows") == true) {
            if (!thSlide.closest(".arrow-wrap").length) {
                thSlide.closest(".container-q").parent().addClass("arrow-wrap");
            }
        }
